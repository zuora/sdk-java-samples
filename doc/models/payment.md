...
| `financeInformation` | `Payment Create Request Finance Information` | | Container for the finance information related to the payment. | `PaymentCreateRequestFinanceInformation getFinanceInformation()`

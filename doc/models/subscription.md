...
| `termStartDate` | `LocalDate` | Optional |  | LocalDate getTermStartDate() |
| `termEndDate` | `LocalDate` | Optional |  | LocalDate getTermEndDate() |
| `autoRenew` | `Boolean` | Optional |  | Boolean getAutoRenew() |
| `mrr` | `Double` | Optional |  | Double getMrr() |
| `tcv` | `Double` | Optional |  | Double getTcv() |
| `version` | `Integer` | Optional |  | Integer getVersion() |
| `cancelAtPeriodEnd` | `Boolean` | Optional |  | Boolean getCancelAtPeriodEnd() |
| `canceledDate` | `LocalDate` | Optional |  | LocalDate getCanceledDate() |
| `suspendedDate` | `LocalDate` | Optional |  | LocalDate getSuspendedDate() |